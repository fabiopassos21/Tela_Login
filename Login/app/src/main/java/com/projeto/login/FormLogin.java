...
private EditText edit_emaill,edit_senha;
...
// manter login
    ...
    public void AuthenticarUsuario(View v) {
        String email = edit_emaill.getText().toString();
        String senha = edit_senha.getText().toString();
...
finish();
    ...
    public void iniciarComponentes(){
        text_tela_cadastro = findViewById(R.id.text_tela_cadastro);
            edit_emaill = findViewById(R.id.text_email);
            edit_senha = findViewById(R.id.text_senha);
